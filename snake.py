...
from core import GRID_SIZE, VECTOR_SIZE, RANDOM_POSITION, RANDOM_VEL, LAYERS_PER_STATE, AI_TRAINING_MODE, RW_HAS_KILLED, \
    RW_HAS_BITTEN, RW_HAS_EATEN, RW_TIME_PASSED, RW_DID_NOT_MOVE, RW_GOT_BITTEN, RW_HAS_BITTEN_HIMSELF, RW_GOT_KILLED, \
    WHITE, DARK_GREY, RED, LEFT, RIGHT, UP, DOWN, DO_NOTHING, INITIAL_SNAKE_LENGTH, DEAD_AT_LENGTH, BIRTH_FROM_LENGTH, \
    fill_cell, pick_random_position
